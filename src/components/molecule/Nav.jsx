      ...
      {navData.map((element, index) => {
        ...
        if (index === 0) {
          temp = (
            ...
            >
              {element} <img src={arrow1} alt="arrow" className="arrow" />{" "}
              <CardLeft visibilityLeft={visibilityLeft} />
            </li>
          );
        } else if (index === 1) {
          temp = (
            <li
              ...
              onMouseLeave={(e) => {
                e.stopPropagation();
                returnrotation_rigth();
              }}
            >
              {element} <img src={arrow2} alt="arrow" className="arrow" />{" "}
              <CardRigth visibilityRigth={visibilityRigth} />
            </li>
          );
        } else {
